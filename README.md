...
**Suivi produit détaillé** : voir **[STATUS.md](STATUS.md)** (vision, état, tests à faire, backlog). Après `make install-user`, une copie est aussi sous `~/.local/share/oaas/STATUS.md`.
